...
2.60,1.91,70.6,185,u,0,0,0,w
4.25,1.11,74.7,185,f,0,0,0,wb
4.22,1.34,11.0,183,f,0,0,0,wb
7.03,2.87,71.9,226,f,0,0,0,w
7.37,4.85,72.2,196,u,0,0,0,w
14.10,5.25,73.5,149,u,0,0,0,w
14.10,2.78,73.3,206,f,0,0,0,w
19.85,4.81,11.4,0,f,0,0,0,w
19.95,7.96,76,0,u,0,0,0,w
17.17,4.95,17.17,0,f,0,0,0,w
17.64,6.86,76,0,u,0,0,0,w
29.03,7,71.6,130,f,0,0,0,w
34.81,12.26,9.8,0,u,0,0,0,w
36.72,10.29,71.9,87,f,0,0,0,wb
37.40,9.74,8,0,f,0,0,0,1"""
...
'''
sns.pairplot(df, vars=['dist', 'std', 'lx', 'reflex'], hue='orientation', palette=color_map)


# Additionally, plot correlation matrix heatmap
corr_matrix = df[['dist', 'std', 'lx','reflex']].corr()
